    ...
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col gap-2  sm:flex-row sm:items-center relative">
          ...
          {!position.lattitude && !position.longitude && <span className="absolute right-[3px] z-50 top-[3px] sm:right-[5px] sm:top-[5px]"><Button disabled={isSubmitting || isLoadingAddress} type="small" onClick={(e)=>{
            e.preventDefault();
        ...
        <div>
          ...
          <input type="hidden" name="position" value={position.longitude && position.latitude ? ` ${position.lattitude},${position.longitude}` : ""}/>
